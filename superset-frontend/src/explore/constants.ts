...
export const FILTER_BOX_TRANSITION_MODE = {
  UNDECIDED: 'UNDECIDED',
  REVIEWING: 'REVIEWING',
  SNOOZED: 'SNOOZED',
  CONVERTED: 'CONVERTED',
};
export const FILTER_BOX_TRANSITION_SNOOZED_AT = 'filter_box_transition_snoozed_at';
export const FILTER_BOX_TRANSITION_SNOOZE_DURATION = 24 * 60 * 60; // 24 hours
